...
Devise.setup do |config|
  ...
  # config.secret_key = '6a3443122d9d36f747db8bde3ae1121bf663084eb5087dd85d1cd2919d67cd444bebffbf03c1df334936599a8604dc6438606bbb1e8df339e3660cb8c82a1c93'
  ...
  config.mailer_sender = "noreply@medarrive.com"
  ...
  # config.pepper = '89b0a0035999ee0e0e0cbd3a147ec49b8610da5469270a1abe22e3c1f1455799162ecfaf8f8f4961f877165c8578fbd5c7c71e07517454f103567a7b1c93fdda'
  ...
  # ********** NOTE: This is configured in User#timeout_in **********
  ...
  config.omniauth(:oktaoauth,
                  ...
                  client_options: {site:          ENV["OKTA_URL"],
                                   authorize_url: "#{ENV['OKTA_URL']}/oauth2/default/v1/authorize",
                                   token_url:     "#{ENV['OKTA_URL']}/oauth2/default/v1/token"},
...
Devise::TokenAuthenticatable.setup do |config|
  ...
  # defaults to nil
  config.token_expires_in = 6.months
